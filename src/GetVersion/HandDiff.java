...
public class HandDiff {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> diffList = handDiff.handleDiff(diffPath3 + File.separator + cve6,
        ...
        ArrayList<String> diffList2 = handDiff.handleDiff(diffPath3 + File.separator + cve6,
