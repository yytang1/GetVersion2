...
public class CheckDiff {
    ...
    public ArrayList<String> getVersionFileExist(String codePath, String versionPrefix,
        ...
        for (String version : versionList) {
            ...
            for (i = 0; i < fileList.length; i++) {
                fileList[i] = fileList[i].replaceAll("[ |　]", " ").replaceAll("\\u00A0", "").trim();
                String filePath = common.getCodefilePath(codePath, versionPrefix, version,
                        fileList[i]);
    ...
    public ArrayList<String> getVersionContainDiff(String cve, String codepath,
        ...
        String[] functionList = (functionNameIsNull > 0 ? vulnerInfo.functionName.split("[;；]")
                : null);
        ...
        for (int i = 0; i < fileList.length; i++) {
            ...
            ArrayList<String> diffStrList = handDiff.handleDiff(cve, fileName, functionName, isOld);
